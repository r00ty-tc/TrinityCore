...
enum WorldDatabaseStatements : uint32
{
    ...
    */
    ...
    WORLD_SEL_MAPPOOL_TEMPLATE,
    WORLD_SEL_MAPPOOL_HIERARCHY,
    WORLD_SEL_MAPPOOL_SPAWNPOINTS,
    WORLD_SEL_MAPPOOL_SPAWNS,
    WORLD_SEL_MAPPOOL_CREATURE_INFO,
    WORLD_SEL_MAPPOOL_GAMEOBJECT_INFO,
    WORLD_SEL_MAPPOOL_CREATURE_OVERRIDE,
    WORLD_SEL_MAPPOOL_GAMEOBJECT_OVERRIDE,
