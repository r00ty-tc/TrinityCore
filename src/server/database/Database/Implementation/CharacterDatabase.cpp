...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHAR_DEL_CREATURE_RESPAWN_BYPOOL, "DELETE FROM creature_respawn WHERE guid = ? AND poolId = ? AND mapId = ? AND instanceId = ?", CONNECTION_ASYNC);
    ...
    PrepareStatement(CHAR_DEL_GO_RESPAWN, "DELETE FROM gameobject_respawn WHERE guid = ? AND  AND mapId = ? AND instanceId = ?", CONNECTION_ASYNC);
