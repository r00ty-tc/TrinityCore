...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_SEL_CREATURE_POOL_RESPAWNS,
    CHAR_REP_CREATURE_POOL_RESPAWN,
    CHAR_DEL_CREATURE_POOL_RESPAWN,
    CHAR_DEL_CREATURE_POOL_RESPAWN_BY_INSTANCE,
    CHAR_SEL_MAX_CREATURE_POOL_RESPAWNS,

    CHAR_SEL_GO_POOL_RESPAWNS,
    CHAR_REP_GO_POOL_RESPAWN,
    CHAR_DEL_GO_POOL_RESPAWN,
    CHAR_DEL_GO_POOL_RESPAWN_BY_INSTANCE,
