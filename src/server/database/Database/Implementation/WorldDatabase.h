...
enum WorldDatabaseStatements
{
    ...
    */
    ...
    WORLD_SEL_MAPPOOL_CREATURE_TEMPLATE,
    WORLD_SEL_MAPPOOL_GAMEOBJECT_TEMPLATE,
    WORLD_SEL_MAPPOOL_CREATURE_HIERARCHY,
    WORLD_SEL_MAPPOOL_GAMEOBJECT_HIERARCHY,
    WORLD_SEL_MAPPOOL_CREATURE_SPAWNS,
    WORLD_SEL_MAPPOOL_GAMEOBJECT_SPAWNS,
    WORLD_SEL_MAPPOOL_CREATURE_INFO,
    WORLD_SEL_MAPPOOL_GAMEOBJECT_INFO,
    WORLD_UPD_MAPPOOL_CREATURE_ZONE_GRID_DATA,
    WORLD_UPD_MAPPOOL_GAMEOBJECT_ZONE_GRID_DATA,
